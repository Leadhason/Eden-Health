      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group overflow-hidden h-[400px]">
                <img src="/alice-7.jfif" alt="Before" className="absolute inset-0 w-full h-full object-cover" />
                <div className="absolute inset-0 w-1/2 overflow-hidden border-r-2 border-white/50 transition-all duration-500 group-hover:w-0">
                    <img src="/alice-1.jfif" alt="After" className="absolute inset-0 w-[200%] max-w-none h-full object-cover grayscale" />
             ...
             <div className="relative group overflow-hidden h-[400px]">
                 <div className="absolute inset-0 flex">
                    <div className="w-1/2 h-full relative">
                        <img src="/alice-2.jfif" alt="Before" className="w-full h-full object-cover grayscale" />
                    </div>
                    <div className="w-1/2 h-full relative">
                        <img src="/alice-3.jfif" alt="After" className="w-full h-full object-cover" />
                    </div>
                 </div>
            ...
            <div className="relative group overflow-hidden h-[400px] hidden lg:block">
                <img src="/alice-4.jfif" alt="Result" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" />
